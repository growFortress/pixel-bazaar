      ...
      >
        ...
        <div className={`relative flex justify-center items-center py-8 mb-4 rounded-xl ${rarityImageBg[product.rarity]} ${rarityRingAccent[product.rarity]}`}>
          <img
            ...
            alt={product.name}
            className="w-36 h-36 object-contain pixel-art transition-transform duration-300 group-hover:scale-110 img-hover-float drop-shadow-xl mix-blend-screen contrast-125 saturate-150 brightness-110"
          />
